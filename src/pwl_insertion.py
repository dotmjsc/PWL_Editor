#!/usr/bin/env python3
"""
PWL Editor - Smart Point Insertion Module
Author: markus(at)schrodt.at
AI Tools: Claude Sonnet 4 (Anthropic) - Code development and architecture
License: GPL-3.0-or-later

Provides intelligent time calculation for inserting points above/below existing points
with notation preservation, consistent stepping, and user-friendly defaults.
"""
